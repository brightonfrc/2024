...
public class SwerveDrive extends Command {
  ...
  @Override
  public void execute() {
    bearingGoal= Math.atan2(controller.getR2Axis(),controller.getRightY());
    //the robot is kinda cucked, so getR2Axis is actually the RightY of the robot
    SmartDashboard.putNumber("Joystick Right X", controller.getR2Axis());
    SmartDashboard.putNumber("Joystick Right Y", controller.getRightY());
    if (bearingGoal<0){
